...
@section('content')
  ...
  <div class="row">
    <div>
      <a class="btn btn-primary" href="{{ action('PosController@edit', $post->id)}}">Edit</a>
      <button id="delete" class="btn btn-danger" href="">Delete</button>
    </div>
  <div>

    {{  Form::open(array('action' => array('PostController@destroy', $post->id), 'method' => 'DELETE', 'id' => 'formDelete')) }}
    {{  Form::close()  }}
    ...
    <script>
      (function()){
        ...
        $('#delete').on('click', function(){
          var onConfirm = confirm('Are you certain?');
